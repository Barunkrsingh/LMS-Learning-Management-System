...
module.exports = {
    markAttendance: async (req, res) => {
        const { studentId, date, status, semesterId } = req.body;
        const departmentId = req.user.departmentId;
        try {
          const attendance = new Attendance({ student: studentId, date, status,semester:semesterId, department:departmentId});
