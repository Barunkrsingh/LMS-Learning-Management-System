...
export default function Students() {
  ...
  const handleSemester = (e) => {
    setParams((prevParams) => ({
      ...prevParams,
      student_semester: e.target.value || undefined,
    }));
  };
    ...
    axios
      ...
      .then((resp) => {
        ...
        Formik.setValues({
          email: data.email,
          name: data.name,
          student_semester: data.student_semester._id,
          gender: data.gender,
          age: data.age,
  ...
  const fetchStudentSemester = () => {
    axios
      ...
      .catch(() => console.log("Error in fetching student Semester"));
  };
      ...
      <Box sx={{ padding: "40px 10px 20px 10px" }}>
            ...
            >
              ...
              <FormControl sx={{ minWidth: "220px", marginTop: "10px" }}>
                ...
                <Select
                  ...
                  onChange={Formik.handleChange}
                  onBlur={Formik.handleBlur}
                  value={Formik.values.student_semester}
                >
                  {studentSemester &&
              ...
              {Formik.touched.student_semester && Formik.errors.student_semester && (
                <p style={{ color: "red", textTransform: "capitalize" }}>
                  {Formik.errors.student_semester}
                </p>
              )}
        ...
        >
          <FormControl sx={{ minWidth: "200px", padding: "5px" }}>
            <InputLabel id="demo-simple-select-label">Student Semester</InputLabel>
            <Select
              labelId="demo-simple-select-label"
              id="demo-simple-select"
              label="Semester"
