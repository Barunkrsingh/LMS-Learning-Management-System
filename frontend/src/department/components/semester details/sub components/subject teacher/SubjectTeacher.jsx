...
export default function SubjectTeacher({semesterId, allSubjects, allTeachers, asignSubTeach, handleMessage}){
     ...
     Formik.setFieldValue("subject", filteredSubTeach.subject._id);
      ...
      const handleDelete = (subTeachId)=>{
        if(confirm("Are you sure you want to delete?")){
          axios
          .delete(`${baseUrl}/semester/sub-teach/delete/${semesterId}/${subTeachId}`)
          .then((resp) => {
      ...
      const Formik = useFormik({
        ...
        onSubmit: (values) => {
            if(isEditSubjTeach){
                axios
                .post(`${baseUrl}/semester/sub-teach/update/${semesterId}/${subTeachId}`, { ...values })
                .then((resp) => {
                  handleMessage("success",resp.data.message);
                })
                .catch((e) => {
                ...
                axios
                .post(`${baseUrl}/semester/sub-teach/new/${semesterId}`, { ...values })
                .then((resp) => {
