...
const Schedule = () => {
  ...
  }, [selectedSemester,openDialog,openAddDialog]);
  ...
  return (
    <Container>
       <Typography semesterName="hero-text" variant="h2" sx={{textAlign:"center"}}>Weekly Schedule</Typography>

      <Paper sx={{ margin: '10px', padding: '10px' }}>
        <FormControl sx={{ minWidth: '220px', marginTop: '10px' }}>
          <Typography >Change Semester</Typography>
          <Select  value={selectedSemester} onChange={handleSemesterChange} onBlur={handleSemesterChange}>
            {allSemesters &&
 ...
 startAccessor="start"
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <AssignPeriod2 semesterId={selectedSemester} isEdit={true} periodId={selectedEvent} close={handleCloseDialog} />
        </DialogContent>
        <DialogActions>
      ...
      <Dialog open={openAddDialog} onClose={handleCloseAddDialog}>
       ...
       <AssignPeriod2 semesterId={selectedSemester} close={handleCloseAddDialog} />
        <DialogActions>
