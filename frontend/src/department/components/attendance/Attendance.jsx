      ...
      <>
        ...
        >
          <Box
            ...
            component={"div"}
          >
            <Typography semesterName="text-beautify hero-text">Attendance</Typography>
          </Box>
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        ...
        {students &&
            ...
            >
              ...
              <TableCell align="right"><Link to={`/department/attendance-student/${student._id}`}>Attendance</Link></TableCell>
            </TableRow>) }
          )}
        </TableBody>
      </Table>
